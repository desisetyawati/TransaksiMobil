...
DefaultTableModel t= new DefaultTableModel();
 ...
 JOptionPane.showMessageDialog(rootPane, e); 
    ...
    private void initComponents() {
        ...
        jLabel7.setBounds(30, 100, 86, 14);
        ...
        tanggal_transaksi.setBounds(180, 90, 140, 30);
        ...
        jButton7.setBounds(351, 90, 60, 30);

        jLabel2.setText("Total Penjualan");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(460, 100, 170, 14);

        jLabel3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(jLabel3);
        jLabel3.setBounds(580, 90, 120, 30);
 ...
 dispose();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            //petunjuk code java 
            res = stat.executeQuery("CALL GetTotalTransaksi("+"'"+tanggal_transaksi.getText()+"'"+")");
            while (res.next()) {
